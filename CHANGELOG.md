...
- [AI-FSSDK] [FSSDK-12368] Remove legacy flag-level holdout fields ([#604](https://github.com/optimizely/java-sdk/pull/604))
- [AI-FSSDK] [FSSDK-12418] Remove experiment type validation from config parsing ([#602](https://github.com/optimizely/java-sdk/pull/602))
- [AI-FSSDK] [FSSDK-12337] Add Feature Rollout support ([#601](https://github.com/optimizely/java-sdk/pull/601))

### Fixes
- [FSSDK-12315] Arnica risk fixes ([#600](https://github.com/optimizely/java-sdk/pull/600))
