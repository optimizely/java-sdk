...
public class AudienceConditionEvaluationTest {
    ...
    List<OptimizelyDecideOption> options = Collections.EMPTY_LIST;
    ...
    public void userAttributeEvaluateTrue() throws Exception {
        ...
        assertTrue(testInstance.evaluate(null, testUserAttributes, options, reasons));
    }
    ...
    public void userAttributeEvaluateFalse() throws Exception {
        ...
        assertFalse(testInstance.evaluate(null, testUserAttributes, options, reasons));
    }
    ...
    public void invalidMatchCondition() throws Exception {
        ...
        assertNull(testInstance.evaluate(null, testUserAttributes, options, reasons));
    }
    ...
    public void unexpectedAttributeTypeNull() throws Exception {
        UserAttribute testInstance = new UserAttribute("browser_type", "custom_attribute", "gt", 20);
        assertNull(testInstance.evaluate(null, Collections.singletonMap("browser_type", null), options, reasons));
    ...
    public void missingAttribute() throws Exception {
        UserAttribute testInstance = new UserAttribute("browser_type", "custom_attribute", "gt", 20);
        assertNull(testInstance.evaluate(null, Collections.EMPTY_MAP, options, reasons));
        logbackVerifier.expectMessage(Level.DEBUG,
    ...
    public void nullAttribute() throws Exception {
        UserAttribute testInstance = new UserAttribute("browser_type", "custom_attribute", "gt", 20);
        assertNull(testInstance.evaluate(null, null, options, reasons));
        logbackVerifier.expectMessage(Level.DEBUG,
            "Audience condition \"{name='browser_type', type='custom_attribute', match='gt', value=20}\" evaluated to UNKNOWN because no value was passed for user attribute \"browser_type\"");
    }
    ...
    public void existsMatchConditionEmptyStringEvaluatesTrue() throws Exception {
        ...
        assertTrue(testInstance.evaluate(null, attributes, options, reasons));
        attributes.put("browser_type", null);
        assertFalse(testInstance.evaluate(null, attributes, options, reasons));
    }
    ...
    public void existsMatchConditionEvaluatesTrue() throws Exception {
        ...
        assertTrue(testInstanceBoolean.evaluate(null, testTypedUserAttributes, options, reasons));
        assertTrue(testInstanceInteger.evaluate(null, testTypedUserAttributes, options, reasons));
        assertTrue(testInstanceDouble.evaluate(null, testTypedUserAttributes, options, reasons));
        assertTrue(testInstanceObject.evaluate(null, testTypedUserAttributes, options, reasons));
    }
    ...
    public void existsMatchConditionEvaluatesFalse() throws Exception {
        ...
        assertFalse(testInstance.evaluate(null, testTypedUserAttributes, options, reasons));
        assertFalse(testInstanceNull.evaluate(null, testTypedUserAttributes, options, reasons));
    }
    ...
    public void exactMatchConditionEvaluatesTrue() {
        ...
        assertTrue(testInstanceString.evaluate(null, testUserAttributes, options, reasons));
        assertTrue(testInstanceBoolean.evaluate(null, testTypedUserAttributes, options, reasons));
        assertTrue(testInstanceInteger.evaluate(null, testTypedUserAttributes, options, reasons));
        assertTrue(testInstanceFloat.evaluate(null, Collections.singletonMap("num_size", (float) 3), options, reasons));
        assertTrue(testInstanceDouble.evaluate(null, testTypedUserAttributes, options, reasons));
    }
    ...
    public void exactMatchConditionEvaluatesNullWithInvalidUserAttr() {
        ...
        assertNull(testInstanceInteger.evaluate(
            null,
            Collections.singletonMap("num_size", bigInteger), options, reasons));
        assertNull(testInstanceFloat.evaluate(
            null,
            Collections.singletonMap("num_size", invalidFloatValue), options, reasons));
        assertNull(testInstanceDouble.evaluate(
            null,
            Collections.singletonMap("num_counts", infinitePositiveInfiniteDouble), options, reasons));
        assertNull(testInstanceDouble.evaluate(
            null,
            Collections.singletonMap("num_counts", infiniteNegativeInfiniteDouble), options, reasons));
        assertNull(testInstanceDouble.evaluate(
            null, Collections.singletonMap("num_counts",
                Collections.singletonMap("num_counts", infiniteNANDouble)), options, reasons));
        assertNull(testInstanceDouble.evaluate(
            null, Collections.singletonMap("num_counts",
                Collections.singletonMap("num_counts", largeDouble)), options, reasons));
    }
    ...
    public void invalidExactMatchConditionEvaluatesNull() {
        ...
        assertNull(testInstanceInteger.evaluate(null, testTypedUserAttributes, options, reasons));
        assertNull(testInstancePositiveInfinite.evaluate(null, testTypedUserAttributes, options, reasons));
        assertNull(testInstanceNegativeInfiniteDouble.evaluate(null, testTypedUserAttributes, options, reasons));
        assertNull(testInstanceNANDouble.evaluate(null, testTypedUserAttributes, options, reasons));
    }
    ...
    public void exactMatchConditionEvaluatesFalse() {
        ...
        assertFalse(testInstanceString.evaluate(null, testUserAttributes, options, reasons));
        assertFalse(testInstanceBoolean.evaluate(null, testTypedUserAttributes, options, reasons));
        assertFalse(testInstanceInteger.evaluate(null, testTypedUserAttributes, options, reasons));
        assertFalse(testInstanceDouble.evaluate(null, testTypedUserAttributes, options, reasons));
    }
    ...
    public void exactMatchConditionEvaluatesNull() {
        ...
        assertNull(testInstanceObject.evaluate(null, testTypedUserAttributes, options, reasons));
        assertNull(testInstanceString.evaluate(null, testUserAttributes, options, reasons));
        assertNull(testInstanceBoolean.evaluate(null, testTypedUserAttributes, options, reasons));
        assertNull(testInstanceInteger.evaluate(null, testTypedUserAttributes, options, reasons));
        assertNull(testInstanceDouble.evaluate(null, testTypedUserAttributes, options, reasons));
        assertNull(testInstanceNull.evaluate(null, testTypedUserAttributes, options, reasons));
        Map<String, Object> attr = new HashMap<>();
        attr.put("browser_type", "true");
        assertNull(testInstanceString.evaluate(null, attr, options, reasons));
    }
    ...
    public void gtMatchConditionEvaluatesTrue() {
        ...
        assertNull(testInstanceInteger.evaluate(null, badAttributes, options, reasons));
    }
    ...
    public void geMatchConditionEvaluatesTrue() {
        ...
        assertTrue(testInstanceInteger.evaluate(null, testTypedUserAttributes, options, reasons));
        assertTrue(testInstanceFloat.evaluate(null, Collections.singletonMap("num_size", (float) 2), options, reasons));
        assertTrue(testInstanceDouble.evaluate(null, testTypedUserAttributes, options, reasons));
    ...
    public void leMatchConditionEvaluatesTrue()  {
        ...
        assertTrue(testInstanceInteger.evaluate(null, testTypedUserAttributes, options, reasons));
        assertTrue(testInstanceDouble.evaluate(null, Collections.singletonMap("num_counts", 5.55), options, reasons));
    }
    ...
    public void testSemanticVersionEqualsMatchInvalidInput() {
        ...
        assertNull(testInstanceString.evaluate(null, testAttributes, options, reasons));
    }
    ...
    public void testIsSemanticNotSameConditionValueMajorMinorPatch() {
        ...
        assertFalse(testInstanceString.evaluate(null, testAttributes, options, reasons));
    }
    ...
    public void testIsSemanticSameSingleDigit() {
        ...
        assertTrue(testInstanceString.evaluate(null, testAttributes, options, reasons));
    }
    ...
    public void notConditionEvaluateNull()  {
        ...
        assertNull(notCondition.evaluate(null, testUserAttributes, options, reasons));
    }
    ...
    public void notConditionEvaluateTrue()  {
        ...
        assertTrue(notCondition.evaluate(null, testUserAttributes, options, reasons));
    ...
    public void notConditionEvaluateFalse()  {
        ...
        NotCondition notCondition = new NotCondition(userAttribute);
        assertFalse(notCondition.evaluate(null, testUserAttributes, options, reasons));
        verify(userAttribute, times(1)).evaluate(eq(null), eq(testUserAttributes), anyObject(), anyObject());
    }
    ...
    public void orConditionEvaluateTrue()  {
        ...
        assertTrue(orCondition.evaluate(null, testUserAttributes, options, reasons));
    ...
    public void orConditionEvaluateNullWithNullAndFalse()  {
        ...
        OrCondition orCondition = new OrCondition(conditions);
        assertNull(orCondition.evaluate(null, testUserAttributes, options, reasons));
        verify(userAttribute1, times(1)).evaluate(eq(null), eq(testUserAttributes), anyObject(), anyObject());
        // shouldn't be called due to short-circuiting in 'Or' evaluation
        verify(userAttribute2, times(1)).evaluate(eq(null), eq(testUserAttributes), anyObject(), anyObject());
    }
    ...
    public void orConditionEvaluateFalseWithFalseAndFalse()  {
        ...
        OrCondition orCondition = new OrCondition(conditions);
        assertFalse(orCondition.evaluate(null, testUserAttributes, options, reasons));
        verify(userAttribute1, times(1)).evaluate(eq(null), eq(testUserAttributes), anyObject(), anyObject());
        // shouldn't be called due to short-circuiting in 'Or' evaluation
        verify(userAttribute2, times(1)).evaluate(eq(null), eq(testUserAttributes), anyObject(), anyObject());
    }
    ...
    public void andConditionEvaluateTrue()  {
        ...
        assertTrue(andCondition.evaluate(null, testUserAttributes, options, reasons));
    ...
    public void andConditionEvaluateFalseWithNullAndFalse()  {
        ...
        AndCondition andCondition = new AndCondition(conditions);
        assertFalse(andCondition.evaluate(null, testUserAttributes, options, reasons));
        verify(orCondition1, times(1)).evaluate(eq(null), eq(testUserAttributes), anyObject(), anyObject());
        verify(orCondition2, times(1)).evaluate(eq(null), eq(testUserAttributes), anyObject(), anyObject());
    }
    ...
    public void andConditionEvaluateNullWithNullAndTrue()  {
        ...
        AndCondition andCondition = new AndCondition(conditions);
        assertNull(andCondition.evaluate(null, testUserAttributes, options, reasons));
        verify(orCondition1, times(1)).evaluate(eq(null), eq(testUserAttributes), anyObject(), anyObject());
        verify(orCondition2, times(1)).evaluate(eq(null), eq(testUserAttributes), anyObject(), anyObject());
    }
    ...
    public void andConditionEvaluateFalse()  {
        ...
        when(orCondition3.evaluate(null, testUserAttributes, options, reasons)).thenReturn(null);
        ...
        assertFalse(andCondition2.evaluate(null, testUserAttributes, options, reasons));
        ...
        assertFalse(andCondition3.evaluate(null, testUserAttributes, options, reasons));
    }
    ...
    public void nullValueEvaluate()  {
        ...
        assertNull(nullValueAttribute.evaluate(null, Collections.<String, String>emptyMap(), options, reasons));
        assertNull(nullValueAttribute.evaluate(null, Collections.singletonMap(attributeName, attributeValue), options, reasons));
        assertNull(nullValueAttribute.evaluate(null, (Collections.singletonMap(attributeName, "")), options, reasons));
    }
}
