...
public class ExperimentBucketerTest {
    ...
    private ExperimentService experimentBucketerService;
    ...
    public void bucketToMultipleVariations() throws Exception {
        ...
        UserContext userContext = new UserContext.Builder()
            ...
            .build();
        assertThat(experimentBucketerService.getDecision(experiment, userContext), is(variations.get(0)));
        bucketValue.set(500);
        ...
        userContext = new UserContext.Builder()
            ...
            .withAttributes(Collections.<String, String>emptyMap())
            .build();
        assertThat(experimentBucketerService.getDecision(experiment, userContext), is(variations.get(1)));
        ...
        userContext = new UserContext.Builder()
            ...
            .withAttributes(Collections.<String, String>emptyMap())
            .build();
        assertThat(experimentBucketerService.getDecision(experiment, userContext), is(variations.get(2)));
        ...
        userContext = new UserContext.Builder()
            ...
            .withAttributes(Collections.<String, String>emptyMap())
            .build();
        assertThat(experimentBucketerService.getDecision(experiment, userContext), is(variations.get(3)));
    }
    ...
    public void bucketToControl() throws Exception {
        ...
        userContext = new UserContext.Builder()
            ...
            .withAttributes(Collections.<String, String>emptyMap())
            .build();
        assertNull(experimentBucketerService.getDecision(experiment, userContext));
    }
    ...
    public void bucketUserInExperiment() throws Exception {
        ...
        UserContext userContext = new UserContext.Builder()
            ...
            .withAttributes(Collections.<String, String>emptyMap())
            .build();
        assertThat(experimentBucketerService.getDecision(groupExperiment, userContext), is(groupExperiment.getVariations().get(0)));
    }
    ...
    public void bucketUserNotInExperiment() throws Exception {
        ...
        UserContext userContext = new UserContext.Builder()
            ...
            .withAttributes(Collections.<String, String>emptyMap())
            .build();
        assertNull(experimentBucketerService.getDecision(groupExperiment, userContext));
    }
    ...
    public void bucketUserToVariationInOverlappingGroupExperiment() throws Exception {
        ...
        UserContext userContext = new UserContext.Builder()
            ...
            .withAttributes(Collections.<String, String>emptyMap())
            .build();
        assertThat(experimentBucketerService.getDecision(groupExperiment, userContext), is(expectedVariation));
    }
