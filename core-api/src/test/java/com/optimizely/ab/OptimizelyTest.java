...
public class OptimizelyTest {
    ...
    public OptimizelyTest(String validDatafile, String noAudienceDatafile) throws ConfigParseException {
        ...
        this.validProjectConfig = new DatafileProjectConfig.Builder().withDatafile(validDatafile).build();
        this.noAudienceProjectConfig = new DatafileProjectConfig.Builder().withDatafile(noAudienceDatafile).build();
    ...
    public void activateUserNullWithListener() throws Exception {
        ...
        int notificationId = optimizely.addNotificationHandler(DecisionNotification.class,
    ...
    public void getEnabledFeaturesWithNoFeatureEnabled() throws Exception {
        ...
        int notificationId = spyOptimizely.addNotificationHandler(DecisionNotification.class, decisionNotification -> { });
    ...
    public void trackEventWithListenerNullAttributes() throws Exception {
     ...
     Map<String, String> attributes = null;
        ...
        int notificationId = optimizely.addNotificationHandler(TrackNotification.class, trackNotification);
    ...
    public void testAddDecisionNotificationHandler() {
        ...
        int notificationId = optimizely.addNotificationHandler(DecisionNotification.class, decisionNotification -> {});
        assertTrue(manager.remove(notificationId));
    }
