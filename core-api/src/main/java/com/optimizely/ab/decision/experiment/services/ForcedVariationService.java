...
/**
 * Returns the forced variation for a given user and experiment if present.
 */
public class ForcedVariationService implements ExperimentService {

    /**
     * Evaluate which forced {@link Variation} user should see.
     *
