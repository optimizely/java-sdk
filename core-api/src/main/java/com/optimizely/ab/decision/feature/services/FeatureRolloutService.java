 ...
 ***************************************************************************/
package com.optimizely.ab.decision.feature.services;
...
/**
 * FeatureRolloutService makes a feature decision for a given feature rollout
 */
public class FeatureRolloutService implements FeatureService {
     ...
     */
    @Override
    public FeatureDecision getDecision(@Nonnull FeatureFlag featureFlag,
